...
\begin{itemize}
  \item \href{https://doi.org/10.32942/x2p07g}{\textit{Interpreting phage ecology, theory, and models in the genomic age}}. Dinesh Kumar Kuppa Baskaran,  Neha Kashyap, James C Kosmopoulos, Marguerite V Langwig, Kris Sankaran, Karthik Anantharaman.
  \item \href{https://doi.org/10.64898/2026.04.16.718997}{\textit{ScSketch: Interactive sketch-based trajectory exploration and pathway-aware analysis of single-cell data}}. Askar Temirbek, Fritz Lekschas, Kris Sankaran, Andres Colubri.
  \item \textit{Design, Processing, and Modeling for Longitudinal Multiomics Microbiome Data}. \underline{Kaiyan Ma}, \underline{Margaret W. Thairu}, Kris Sankaran.
...
\begin{itemize}
  \item \href{https://doi.org/10.1038/s41522-026-00975-z}{Caenorhabditis elegans \textit{populations shape their microbial environment}}. Rahul Bodkhe, Kris Sankaran, Michael Shapira. npj Biofilms Microbes (2026).
  \item \href{https://doi.org/10.1093/bioinformatics/btag151 }{\textit{phylobar: an R package for multiresolution compositional barplots in omics studies.}} \underline{Megan Kuo}, Kim-Anh Lê Cao, Saritha Kodikara, Jiadong Mao, and Kris Sankaran. Bioinformatics (Oxford, England), 42 no. 4 (2026).
  \item \href{https://doi.org/10.1093/bib/bbag136 }{\textit{Interactive visualization of metric distortion in nonlinear data embeddings using the distortions package}}. Kris Sankaran, Shuzhen Zhang, Chenab, Marina Meilă. Briefings in Bioinformatics, 27, no. 2 (2026).
...
\item \textbf{Thesis Committee Member:} Auden Krauska, Elaine Chiu, Dinesh Kumar
Kuppa Baskaran, Shuyang Chen, Albert Dorador Chalar, Jitian Zhao, Jingqi Duan,
Siyu Zhang, Emily Diaz Vallejo, Shan Lu, Jinyi Wang, Shana Ederer
\item \textbf{MSAS Committee:} Maria Elisa Montes Gonzales, Yushin Wei
\item \textbf{Preliminary Exam Committee Member}: Chenghui Zheng, Tinghui Xu, Zhongxuan Sun
...
\begin{itemize}
  ...
  \item \href{https://go.wisc.edu/241m5e}{Modular Software for Mediation Analysis of Microbiome Data}. UW Madison Microbiome Symposium (05/2026).
  \item \href{https://go.wisc.edu/9g3mce}{Interactively Resolving Distortion in Nonlinear Dimensionality Reduction}. Symposium on Data Science and Statistics (04/2025).
  \item \href{https://go.wisc.edu/mzhs15}{New Diagnostics for Dimensionality Reduction of Genomic Data}. University of Michigan Biostatistics Seminar. (02/2026).
...
\begin{itemize}
\item \href{https://github.com/krisrs1128/scDesigner}{\texttt{scDesigner}}:
A modular interface for designing single cell and spatial omics simulations for
synthetic negative controls and methods benchmarking.
...
\begin{itemize}
\item Data Science for Biology Workshop Series. \href{https://krisrs1128.github.io/durban_workshop/notes.html}{Modeling and Uncertainty} (06/2026)
