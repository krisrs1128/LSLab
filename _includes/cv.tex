...
Glacial Lake Trends using Historically Guided Segmentation Models. Revised
(April 2022).
...
(January 2022).
\item Min, Yan, Yuan Ru, Kris Sankaran, Ninglin Wang, Peng Gao, Lijin Chen,
Sherry Zhao, Sankuan Zhu, Ann Hsing, Ying Lu. Circulating Metabolites Mediate
the Sex-specific Associations Between Gut Microbiome and Body Fat
Distribution. Submitted (2021).
\end{itemize}
...
Segmentation. ISPRS International Journal of Geo-Information. 11(8):415.
...
\item Fukuyama, Julia, Kris Sankaran, Laura Symul, Multiscale analysis of count data
through topic alignment, Biostatistics, 2022.
...
\begin{itemize}
  ...
  \item \href{https://drive.google.com/file/d/1kq0xJ3XS98igzxFcJOTFUEz2DtoRByCg/view?usp=sharing}{Is a PhD right for me?} Guest Lecture, STAT 627 (02/2022)
...
\begin{itemize}
\item \textit{STAT 627}. Guest Lecture on ``Reflections on the Statistics PhD.'' February 2022.
...
of Machine Learning.''} December 2021.
\item \textit{Data Science Nigeria AI Bootcamp instructor}.
Session on \href{https://drive.google.com/file/d/1bgYQb8z1iCjHyOG1gVWeJJCSPdssndVP/view}{``Understanding Machine Learning''}.\\
October 2021.
\item \textit{Data Science Nigeria AI Bootcamp instructor}.
Sessions on \href{https://www.youtube.com/watch?v=7_8DUN-6tpI&}{``AI for Social Good''} and \href{https://www.youtube.com/watch?v=EefWzpRkIVM}{``Statistics and Machine Learning''}.
November 2020.
...
\begin{itemize}
\item Reviewer for \textit{BMC Bioinformatics}, \textit{The Journal of Machine
Learning Research}, \textit{Annals of Applied Statistics}, \textit{eLife},
\textit{The R Journal}, \textit{Biometrics}, \textit{Biostatistics},
\textit{Frontiers of Computer Science}, \textit{The Journal of the American
Statistical Association}, \textit{Microbiome}, \textit{F1000 Research}.
...
\item Judge for UW Madison Statistics Club Data Challenge. October 2021.
